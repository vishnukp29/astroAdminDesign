...
import deepawali from "../../Assests/deepawali.jpg";
        ...
        <div className="m-4 bg-white rounded-md shadow-indigo-50 p-5 ">
          ...
          <table className="border border-gray-300 w-full text-sm md:text-md   ">
            ...
            <tr className="bg-gray-200 h-4">
              ...
              <td className="border border-gray-300 p-2  ">
                <img src={deepawali} height="120px" width="120px" />
              </td>
              <td className="border border-gray-300 p-2  ">Title</td>
              <td className="border border-gray-300 p-2  ">my first post</td>
            ...
            <tr className="h-8">
              ...
              <td className="border border-gray-300 p-2 ">
                <img src={laptop} height="120px" width="120px" />
              </td>
              <td className="border border-gray-300 p-2  ">Title</td>
              <td className="border border-gray-300 p-2  ">my first post</td>
              <td className="border border-gray-300 p-2  ">2</td>
              ...
              <div className="flex align-center justify-center gap-2 p-5">
                <div className="flex border border-blue-500 p-2 rounded-md">
                  <CiEdit size={20} color="blue" />
                  <button className="text-blue-500">edit</button>
                </div>
            ...
            <tr>
              ...
              <th className="border border-gray-300 p-2 ">Astrologer</th>
              ...
              <th className="border border-gray-300 p-2">Created Data</th>
