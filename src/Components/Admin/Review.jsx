    ...
    <div className="h-full bg-slate-200 flex ">
      ...
      <div className=" ">
        <div className="flex justify-between m-4">
          ...
          <div>
            <div> <span className="hover:cursor-pointer hover:text-red-400">Home/</span><span>Review List</span></div>
          </div>
        </div>
        ...
        <div className="m-4 bg-white rounded-md shadow-indigo-50 p-5 ">
          ...
          <table className="border border-gray-300 w-full text-sm md:text-md   ">
            <tr className="h-16 ">
              ...
              <th className="border border-gray-300 md:p-5 "><div className="flex justify-between justify-items-center items-center text-center"><div>Rating</div><div><BsArrowDownUp size={12}/></div></div></th>
              <th className="border border-gray-300 md:p-5 "><div className="flex justify-between justify-items-center items-center text-center"><div>Comment</div><div><BsArrowDownUp size={12}/></div></div></th>
            ...
            <tr className="bg-gray-200 h-16">
              ...
              <td className="border border-gray-300 md:p-5 ">5.00 / 5.00</td>

              <td className="border border-gray-300 md:p-5 ">NICE SHIVfghjkl</td>
              <td className="border border-gray-300 md:p-5 ">
            ...
            <tr>
              ...
              <th className="border border-gray-300 md:p-5 ">Rating</th>
              <th className="border border-gray-300 md:p-5 ">Comment </th>
