        ...
        <div className="m-4 bg-white rounded-md shadow-indigo-50 p-5 ">
          ...
          <table className="border border-gray-300 w-full text-sm md:text-md   ">
            <tr className="h-16 ">
              ...
              <th className="border border-gray-300 md:p-5 "><div className="flex justify-between justify-items-center items-center text-center"><div>User/ Astrologer</div><div><BsArrowDownUp size={12}/></div></div></th>
              <th className="border border-gray-300 md:p-5 "><div className="flex justify-between justify-items-center items-center text-center"><div>Seen Status</div><div><BsArrowDownUp size={12}/></div></div></th>
            ...
            <tr className="bg-gray-200 h-4">
              ...
              <td className="border border-gray-300 p-2 text-center  ">User</td>
              <td className="border border-gray-300 p-2 text-center  ">seen</td>
            ...
            <tr>
              ...
              <th className="border border-gray-300 p-2">User/Astrologer</th>
              <th className="border border-gray-300 p-2">Seen Status</th>
